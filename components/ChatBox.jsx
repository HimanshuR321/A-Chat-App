    ...
    >
      <div className="chat-info">
        ...
        <div className="flex flex-col gap-1">
          {chat?.isGroup ? (
            <p className="text-base-bold text-blue-800">{chat?.name}</p>
          ) : (
            <p className="text-base-bold text-blue-800">{otherMembers[0]?.username}</p>
          )}
          ...
          {lastMessage?.photo ? (
            lastMessage?.sender?._id === currentUser._id ? (
              ...
              <p
                className={`${
                  seen ? "text-small-medium text-grey-3" : "text-small-bold text-green-500"
                }`}
              >
                Received a picture
              </p>
      ...
      <div>
        <p className="text-base-light text-blue-3">
          {!lastMessage
