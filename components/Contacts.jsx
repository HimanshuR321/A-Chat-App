    ...
    <div className="create-chat-container">
      ...
      <div className="contact-bar">
        <div className="contact-list">
          <p className="text-body-bold text-blue-600">Select or Deselect</p>
            ...
            {contacts.map((user, index) => (
              ...
              >
                {selectedContacts.find((item) => item === user) ? (
                  ...
                  <RadioButtonUnchecked className="text-blue-400"/>
                )}
                <img
                ...
                />
                <p className="text-base-bold text-cyan-900">{user.username}</p>
              </div>
            ))}
          </div>
        </div>
